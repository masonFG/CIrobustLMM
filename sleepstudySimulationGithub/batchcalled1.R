...
#baobab
options(echo=TRUE) 
i <- commandArgs(trailingOnly = TRUE)[9]
 i=str_split(i,"=")
...
nameparam = paste0("estimator",estimator,"bootstrap",bootstrap,"NTot",NTot,"J" = J, "extr.resid",extp1,"extr.ranI",extRANI1,"extr.ranS",extRANP1,"rseed",rseed)
