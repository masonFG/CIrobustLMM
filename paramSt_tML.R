...
# Date: September, 2019
# R version: 3.5.1
# Comment: R code for analyses presented in titres-du-papier - this script contains the sleepstudy example with the Student-parametric bootstrap on multivariate t-ML
# ---------------------------------------------------------------------
