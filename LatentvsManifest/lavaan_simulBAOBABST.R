...
'
  ...
  for (i in 1:B){
    ...
    results_wide<-rbind(lavaan_wide,result_ttest_wide,result_LRT_wide)#,result_lmer_wide
    ...
    results_high<-rbind(lavaan_high,result_ttest_high,result_LRT_high)#,result_lmer_high
    ...
    # 
    results_low<-rbind(lavaan_low,result_ttest_low,result_LRT_low)#,result_lmer_low
